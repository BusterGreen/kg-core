local Translations = {
    error = {
        ...
        duplicate_license           = '[KGCORE] - Duplicate Rockstar License Found',
        no_valid_license            = '[KGCORE] - No Valid Rockstar License Found',
        not_whitelisted             = '[KGCORE] - You\'re not whitelisted for this server',
        ...
        connecting_database_error   = '[KGCORE] - A database error occurred while connecting to the server. (Is the SQL server on?)',
        connecting_database_timeout = '[KGCORE] - Connection to database timed out. (Is the SQL server on?)',
    },
    success = {
