local Translations = {
    error = {
        ...
        duplicate_license           = '[KGCORE] - Rockstarライセンスが重複しています',
        no_valid_license            = '[KGCORE] - 有効なRockstarライセンスが見つかりません',
        not_whitelisted             = '[KGCORE] - あなたはホワイトリストに登録されていません',
        ...
        connecting_database_error   = '[KGCORE] - サーバーへの接続中にデータベースエラーが発生しました(SQLサーバの稼働を確認してください)',
        connecting_database_timeout = '[KGCORE] - データベースへの接続がタイムアウトしました(SQLサーバーの稼働を確認してください)',
    },
    success = {
